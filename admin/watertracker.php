...
$query  = "SELECT * FROM `watertracker`  ORDER BY `watertracker`.`id` DESC";
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">watertracker Data Table</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                                    ...
                                    <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                        ...
                                        <tbody>
                                            ...
                                            while ($result_arr = mysqli_fetch_assoc($resnum)) {
                                                $query  = "SELECT * FROM `users` WHERE id='" . $result_arr['userid'] . "'";
                                                $resnumUs = mysqli_query($con, $query);
                                                $result_arrUs = mysqli_fetch_assoc($resnumUs);
                                            ?>
                                                <tr role="row" class="odd">
                                                    <td class="sorting_1"><?php echo $i; ?></td>
                                                    <td><?php echo $result_arr['watercount']; ?></td>
                                                    <td><?php echo $result_arrUs['name']; ?></td>
                                                    <td>
                                                        <a href="<?php echo BASE_URL; ?>/editWatertracker.php?id=<?php echo $result_arr['id']; ?>">Edit</a>|
                                                        <a href="<?php echo BASE_URL; ?>/deleteWatertracker.php?id=<?php echo $result_arr['id']; ?>">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php
                                                $i++;
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th rowspan="1" colspan="1" style="color: green">watercount</th>
                                                <th rowspan="1" colspan="1" style="color: green">userid</th>
