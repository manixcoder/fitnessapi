...
$query  = "SELECT * FROM `medical_condition_master`  ORDER BY `medical_condition_master`.`id` DESC";
...
<div class="content-wrapper" style="min-height: 916.281px;">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Medical Condition Data</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <a href="<?php echo BASE_URL; ?>/addMedicalConditionMaster.php">Add Medical Condition</a>
                <div class="box">
                                    ...
                                    <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <?php echo $result_arr['MC']; ?>
                                                    </td>

                                                    <td>
                                                        <a href="<?php echo BASE_URL; ?>/editMedicalConditionMaster.php?id=<?php echo $result_arr['id']; ?>">Edit</a>|
                                                        <a href="<?php echo BASE_URL; ?>/deleteMedicalConditionMaster.php?id=<?php echo $result_arr['id']; ?>">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php
                                                $i++;
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th rowspan="1" colspan="1" style="color: green">MC</th>
