...
$query  = "SELECT * FROM `healthmaster`  ORDER BY `healthmaster`.`id` DESC";
                                    ...
                                    <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><?php echo $result_arr['heading']; ?></td>
                                                    <td>
                                                        <a href="<?php echo BASE_URL; ?>/edithealthmaster.php?id=<?php echo $result_arr['id']; ?>">Edit</a>|
                                                        <a href="<?php echo BASE_URL; ?>/deletehealthmaster.php?id=<?php echo $result_arr['id']; ?>">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php
                                                $i++;
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th rowspan="1" colspan="1" style="color: green">heading</th>
